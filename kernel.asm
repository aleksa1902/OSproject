...
0000000080000000 <_entry>:
    ...
    80000004:	98013103          	ld	sp,-1664(sp) # 80005980 <_GLOBAL_OFFSET_TABLE_+0x28>
...
_ZN5Riscv14supervisorTrapEv:
    ...
    80001184:	2bd000ef          	jal	ra,80001c40 <_ZN5Riscv20handleSupervisorTrapEv>
...
0000000080001300 <_Z15thread_dispatchv>:
...
0000000080001324 <_Z8sem_openPP4_semj>:
...
int sem_open (sem_t* handle, unsigned init){
    ...
    __asm__ volatile("mv %0, a1" : "=r" (arg2));
    80001334:	00058793          	mv	a5,a1
    __asm__ volatile("mv a0, %0" : : "r" (num));
    80001338:	01500693          	li	a3,21
    8000133c:	00068513          	mv	a0,a3
    __asm__ volatile("mv a1, %0" : : "r" (arg1));
    80001340:	00070593          	mv	a1,a4
    __asm__ volatile("mv a2, %0" : : "r" (arg2));
    80001344:	00078613          	mv	a2,a5
...
int sem_close (sem_t handle){
    ...
    __asm__ volatile("mv a0, %0" : : "r" (num));
    8000136c:	01600713          	li	a4,22
    80001370:	00070513          	mv	a0,a4
    __asm__ volatile("mv a1, %0" : : "r" (arg1));
...
int sem_wait (sem_t id){
    ...
    __asm__ volatile("mv a0, %0" : : "r" (num));
    8000139c:	01700713          	li	a4,23
    800013a0:	00070513          	mv	a0,a4
    __asm__ volatile("mv a1, %0" : : "r" (arg1));
    800013a4:	00078593          	mv	a1,a5
...
int sem_signal (sem_t id){
    ...
    __asm__ volatile("mv a0, %0" : : "r" (num));
    800013cc:	01800713          	li	a4,24
    800013d0:	00070513          	mv	a0,a4
    __asm__ volatile("mv a1, %0" : : "r" (arg1));
    800013d4:	00078593          	mv	a1,a5
...
00000000800013ec <_Z11workerBodyAPv>:
#include "../h/print.hpp"
#include "../h/ccb.hpp"
#include "../h/tcb.hpp"
...
void workerBodyA(void *pVoid) {
    ...
    80001404:	0300006f          	j	80001434 <_Z11workerBodyAPv+0x48>
        printString("A: i="); printInteger(i); printString("\n");
        for (uint64 j = 0; j < 10000; j++) {
    80001408:	00168693          	addi	a3,a3,1
    8000140c:	000027b7          	lui	a5,0x2
    80001410:	70f78793          	addi	a5,a5,1807 # 270f <_entry-0x7fffd8f1>
    80001414:	00d7ee63          	bltu	a5,a3,80001430 <_Z11workerBodyAPv+0x44>
            for (uint64 k = 0; k < 30000; k++) { /* busy wait */ }
    80001418:	00000713          	li	a4,0
    8000141c:	000077b7          	lui	a5,0x7
    80001420:	52f78793          	addi	a5,a5,1327 # 752f <_entry-0x7fff8ad1>
    80001424:	fee7e2e3          	bltu	a5,a4,80001408 <_Z11workerBodyAPv+0x1c>
    80001428:	00170713          	addi	a4,a4,1
    8000142c:	ff1ff06f          	j	8000141c <_Z11workerBodyAPv+0x30>
    for (uint64 i = 0; i < 10; i++) {
    80001430:	00148493          	addi	s1,s1,1
    80001434:	00900793          	li	a5,9
    80001438:	0297ec63          	bltu	a5,s1,80001470 <_Z11workerBodyAPv+0x84>
        printString("A: i="); printInteger(i); printString("\n");
    8000143c:	00004517          	auipc	a0,0x4
    80001440:	be450513          	addi	a0,a0,-1052 # 80005020 <CONSOLE_STATUS+0x10>
    80001444:	00001097          	auipc	ra,0x1
    80001448:	d68080e7          	jalr	-664(ra) # 800021ac <_Z11printStringPKc>
    8000144c:	00048513          	mv	a0,s1
    80001450:	00001097          	auipc	ra,0x1
    80001454:	dcc080e7          	jalr	-564(ra) # 8000221c <_Z12printIntegerm>
    80001458:	00004517          	auipc	a0,0x4
    8000145c:	c9850513          	addi	a0,a0,-872 # 800050f0 <CONSOLE_STATUS+0xe0>
    80001460:	00001097          	auipc	ra,0x1
    80001464:	d4c080e7          	jalr	-692(ra) # 800021ac <_Z11printStringPKc>
        for (uint64 j = 0; j < 10000; j++) {
    80001468:	00000693          	li	a3,0
    8000146c:	fa1ff06f          	j	8000140c <_Z11workerBodyAPv+0x20>
            // TCB::yield();
        }
    }
}
...
0000000080001484 <_Z11workerBodyBPv>:
...
void workerBodyB(void *pVoid) {
    ...
    8000149c:	0300006f          	j	800014cc <_Z11workerBodyBPv+0x48>
    ...
    800014ac:	00d7ee63          	bltu	a5,a3,800014c8 <_Z11workerBodyBPv+0x44>
            for (uint64 k = 0; k < 30000; k++) { /* busy wait */ }
    800014b0:	00000713          	li	a4,0
    800014b4:	000077b7          	lui	a5,0x7
    800014b8:	52f78793          	addi	a5,a5,1327 # 752f <_entry-0x7fff8ad1>
    800014bc:	fee7e2e3          	bltu	a5,a4,800014a0 <_Z11workerBodyBPv+0x1c>
    800014c0:	00170713          	addi	a4,a4,1
    800014c4:	ff1ff06f          	j	800014b4 <_Z11workerBodyBPv+0x30>
    for (uint64 i = 0; i < 16; i++) {
    800014c8:	00148493          	addi	s1,s1,1
    800014cc:	00f00793          	li	a5,15
    800014d0:	0297ec63          	bltu	a5,s1,80001508 <_Z11workerBodyBPv+0x84>
        printString("B: i="); printInteger(i); printString("\n");
    800014d4:	00004517          	auipc	a0,0x4
    800014d8:	b5450513          	addi	a0,a0,-1196 # 80005028 <CONSOLE_STATUS+0x18>
    800014dc:	00001097          	auipc	ra,0x1
    800014e0:	cd0080e7          	jalr	-816(ra) # 800021ac <_Z11printStringPKc>
    800014e4:	00048513          	mv	a0,s1
    800014e8:	00001097          	auipc	ra,0x1
    800014ec:	d34080e7          	jalr	-716(ra) # 8000221c <_Z12printIntegerm>
    ...
    800014fc:	cb4080e7          	jalr	-844(ra) # 800021ac <_Z11printStringPKc>
        for (uint64 j = 0; j < 10000; j++) {
    80001500:	00000693          	li	a3,0
    80001504:	fa1ff06f          	j	800014a4 <_Z11workerBodyBPv+0x20>
            // TCB::yield();
        }
    }
}
...
000000008000151c <_Z9fibonaccim>:
...
uint64 fibonacci(uint64 n) {
    ...
    8000153c:	02a7f863          	bgeu	a5,a0,8000156c <_Z9fibonaccim+0x50>
    if (n % 10 == 0) { TCB::yield(); }
    80001540:	00a00793          	li	a5,10
    80001544:	02f577b3          	remu	a5,a0,a5
    80001548:	02078e63          	beqz	a5,80001584 <_Z9fibonaccim+0x68>
    return fibonacci(n - 1) + fibonacci(n - 2);
    8000154c:	fff48513          	addi	a0,s1,-1
    80001550:	00000097          	auipc	ra,0x0
    80001554:	fcc080e7          	jalr	-52(ra) # 8000151c <_Z9fibonaccim>
    80001558:	00050913          	mv	s2,a0
    8000155c:	ffe48513          	addi	a0,s1,-2
    80001560:	00000097          	auipc	ra,0x0
    80001564:	fbc080e7          	jalr	-68(ra) # 8000151c <_Z9fibonaccim>
    80001568:	00a90533          	add	a0,s2,a0
}
    ...
    80001588:	508080e7          	jalr	1288(ra) # 80001a8c <_ZN3TCB5yieldEv>
    8000158c:	fc1ff06f          	j	8000154c <_Z9fibonaccim+0x30>

0000000080001590 <_Z11workerBodyCPv>:
void workerBodyC(void *pVoid) {
    ...
    800015a0:	01213023          	sd	s2,0(sp)
    800015a4:	02010413          	addi	s0,sp,32
    uint8 i = 0;
    800015a8:	00000493          	li	s1,0
    800015ac:	0380006f          	j	800015e4 <_Z11workerBodyCPv+0x54>
    for (; i < 3; i++) {
        printString("C: i="); printInteger(i); printString("\n");
    800015b0:	00004517          	auipc	a0,0x4
    800015b4:	a8050513          	addi	a0,a0,-1408 # 80005030 <CONSOLE_STATUS+0x20>
    ...
    800015d0:	b2450513          	addi	a0,a0,-1244 # 800050f0 <CONSOLE_STATUS+0xe0>
    ...
    800015e4:	00200793          	li	a5,2
    800015e8:	fc97f4e3          	bgeu	a5,s1,800015b0 <_Z11workerBodyCPv+0x20>
    }

    printString("C: yield\n");
    800015ec:	00004517          	auipc	a0,0x4
    800015f0:	a4c50513          	addi	a0,a0,-1460 # 80005038 <CONSOLE_STATUS+0x28>
    800015f4:	00001097          	auipc	ra,0x1
    800015f8:	bb8080e7          	jalr	-1096(ra) # 800021ac <_Z11printStringPKc>
    __asm__ ("li t1, 7");
    800015fc:	00700313          	li	t1,7
    TCB::yield();
    80001600:	00000097          	auipc	ra,0x0
    80001604:	48c080e7          	jalr	1164(ra) # 80001a8c <_ZN3TCB5yieldEv>

    uint64 t1 = 0;
    __asm__ ("mv %[t1], t1" : [t1] "=r"(t1));
    80001608:	00030913          	mv	s2,t1

    printString("C: t1="); printInteger(t1); printString("\n");
    8000160c:	00004517          	auipc	a0,0x4
    80001610:	a3c50513          	addi	a0,a0,-1476 # 80005048 <CONSOLE_STATUS+0x38>
    80001614:	00001097          	auipc	ra,0x1
    80001618:	b98080e7          	jalr	-1128(ra) # 800021ac <_Z11printStringPKc>
    8000161c:	00090513          	mv	a0,s2
    80001620:	00001097          	auipc	ra,0x1
    80001624:	bfc080e7          	jalr	-1028(ra) # 8000221c <_Z12printIntegerm>
    80001628:	00004517          	auipc	a0,0x4
    8000162c:	ac850513          	addi	a0,a0,-1336 # 800050f0 <CONSOLE_STATUS+0xe0>
    80001630:	00001097          	auipc	ra,0x1
    80001634:	b7c080e7          	jalr	-1156(ra) # 800021ac <_Z11printStringPKc>

    uint64 result = fibonacci(12);
    80001638:	00c00513          	li	a0,12
    8000163c:	00000097          	auipc	ra,0x0
    80001640:	ee0080e7          	jalr	-288(ra) # 8000151c <_Z9fibonaccim>
    80001644:	00050913          	mv	s2,a0
    printString("C: fibonaci="); printInteger(result); printString("\n");
    80001648:	00004517          	auipc	a0,0x4
    8000164c:	a0850513          	addi	a0,a0,-1528 # 80005050 <CONSOLE_STATUS+0x40>
    80001650:	00001097          	auipc	ra,0x1
    80001654:	b5c080e7          	jalr	-1188(ra) # 800021ac <_Z11printStringPKc>
    80001658:	00090513          	mv	a0,s2
    8000165c:	00001097          	auipc	ra,0x1
    80001660:	bc0080e7          	jalr	-1088(ra) # 8000221c <_Z12printIntegerm>
    80001664:	00004517          	auipc	a0,0x4
    80001668:	a8c50513          	addi	a0,a0,-1396 # 800050f0 <CONSOLE_STATUS+0xe0>
    8000166c:	00001097          	auipc	ra,0x1
    80001670:	b40080e7          	jalr	-1216(ra) # 800021ac <_Z11printStringPKc>
    80001674:	0380006f          	j	800016ac <_Z11workerBodyCPv+0x11c>

    for (; i < 6; i++) {
        printString("C: i="); printInteger(i); printString("\n");
    80001678:	00004517          	auipc	a0,0x4
    8000167c:	9b850513          	addi	a0,a0,-1608 # 80005030 <CONSOLE_STATUS+0x20>
    80001680:	00001097          	auipc	ra,0x1
    80001684:	b2c080e7          	jalr	-1236(ra) # 800021ac <_Z11printStringPKc>
    80001688:	00048513          	mv	a0,s1
    8000168c:	00001097          	auipc	ra,0x1
    80001690:	b90080e7          	jalr	-1136(ra) # 8000221c <_Z12printIntegerm>
    80001694:	00004517          	auipc	a0,0x4
    80001698:	a5c50513          	addi	a0,a0,-1444 # 800050f0 <CONSOLE_STATUS+0xe0>
    8000169c:	00001097          	auipc	ra,0x1
    800016a0:	b10080e7          	jalr	-1264(ra) # 800021ac <_Z11printStringPKc>
    for (; i < 6; i++) {
    800016a4:	0014849b          	addiw	s1,s1,1
    800016a8:	0ff4f493          	andi	s1,s1,255
    800016ac:	00500793          	li	a5,5
    800016b0:	fc97f4e3          	bgeu	a5,s1,80001678 <_Z11workerBodyCPv+0xe8>
    }
//    TCB::yield();
}
...
00000000800016cc <_Z11workerBodyDPv>:
void workerBodyD(void *pVoid) {
    ...
    uint8 i = 10;
    800016e4:	00a00493          	li	s1,10
    800016e8:	0380006f          	j	80001720 <_Z11workerBodyDPv+0x54>
    for (; i < 13; i++) {
        printString("D: i="); printInteger(i); printString("\n");
    800016ec:	00004517          	auipc	a0,0x4
    800016f0:	97450513          	addi	a0,a0,-1676 # 80005060 <CONSOLE_STATUS+0x50>
    800016f4:	00001097          	auipc	ra,0x1
    800016f8:	ab8080e7          	jalr	-1352(ra) # 800021ac <_Z11printStringPKc>
    800016fc:	00048513          	mv	a0,s1
    80001700:	00001097          	auipc	ra,0x1
    80001704:	b1c080e7          	jalr	-1252(ra) # 8000221c <_Z12printIntegerm>
    80001708:	00004517          	auipc	a0,0x4
    8000170c:	9e850513          	addi	a0,a0,-1560 # 800050f0 <CONSOLE_STATUS+0xe0>
    80001710:	00001097          	auipc	ra,0x1
    80001714:	a9c080e7          	jalr	-1380(ra) # 800021ac <_Z11printStringPKc>
    for (; i < 13; i++) {
    80001718:	0014849b          	addiw	s1,s1,1
    8000171c:	0ff4f493          	andi	s1,s1,255
    80001720:	00c00793          	li	a5,12
    80001724:	fc97f4e3          	bgeu	a5,s1,800016ec <_Z11workerBodyDPv+0x20>
    }

    printString("D: yield\n");
    80001728:	00004517          	auipc	a0,0x4
    8000172c:	94050513          	addi	a0,a0,-1728 # 80005068 <CONSOLE_STATUS+0x58>
    80001730:	00001097          	auipc	ra,0x1
    80001734:	a7c080e7          	jalr	-1412(ra) # 800021ac <_Z11printStringPKc>
    __asm__ ("li t1, 5");
    80001738:	00500313          	li	t1,5
    TCB::yield();
    8000173c:	00000097          	auipc	ra,0x0
    80001740:	350080e7          	jalr	848(ra) # 80001a8c <_ZN3TCB5yieldEv>

    uint64 result = fibonacci(16);
    80001744:	01000513          	li	a0,16
    80001748:	00000097          	auipc	ra,0x0
    8000174c:	dd4080e7          	jalr	-556(ra) # 8000151c <_Z9fibonaccim>
    80001750:	00050913          	mv	s2,a0
    printString("D: fibonaci="); printInteger(result); printString("\n");
    80001754:	00004517          	auipc	a0,0x4
    80001758:	92450513          	addi	a0,a0,-1756 # 80005078 <CONSOLE_STATUS+0x68>
    8000175c:	00001097          	auipc	ra,0x1
    80001760:	a50080e7          	jalr	-1456(ra) # 800021ac <_Z11printStringPKc>
    80001764:	00090513          	mv	a0,s2
    80001768:	00001097          	auipc	ra,0x1
    8000176c:	ab4080e7          	jalr	-1356(ra) # 8000221c <_Z12printIntegerm>
    80001770:	00004517          	auipc	a0,0x4
    80001774:	98050513          	addi	a0,a0,-1664 # 800050f0 <CONSOLE_STATUS+0xe0>
    80001778:	00001097          	auipc	ra,0x1
    8000177c:	a34080e7          	jalr	-1484(ra) # 800021ac <_Z11printStringPKc>
    80001780:	0380006f          	j	800017b8 <_Z11workerBodyDPv+0xec>

    for (; i < 16; i++) {
        printString("D: i="); printInteger(i); printString("\n");
    80001784:	00004517          	auipc	a0,0x4
    80001788:	8dc50513          	addi	a0,a0,-1828 # 80005060 <CONSOLE_STATUS+0x50>
    8000178c:	00001097          	auipc	ra,0x1
    80001790:	a20080e7          	jalr	-1504(ra) # 800021ac <_Z11printStringPKc>
    80001794:	00048513          	mv	a0,s1
    80001798:	00001097          	auipc	ra,0x1
    8000179c:	a84080e7          	jalr	-1404(ra) # 8000221c <_Z12printIntegerm>
    800017a0:	00004517          	auipc	a0,0x4
    800017a4:	95050513          	addi	a0,a0,-1712 # 800050f0 <CONSOLE_STATUS+0xe0>
    800017a8:	00001097          	auipc	ra,0x1
    800017ac:	a04080e7          	jalr	-1532(ra) # 800021ac <_Z11printStringPKc>
    for (; i < 16; i++) {
    800017b0:	0014849b          	addiw	s1,s1,1
    800017b4:	0ff4f493          	andi	s1,s1,255
    800017b8:	00f00793          	li	a5,15
    800017bc:	fc97f4e3          	bgeu	a5,s1,80001784 <_Z11workerBodyDPv+0xb8>
    }
//    TCB::yield();
}
...
int main() {
    ...
    800017e8:	03213823          	sd	s2,48(sp)
    800017ec:	05010413          	addi	s0,sp,80
    MemoryAllocator::memAlloc();
    800017f0:	00000097          	auipc	ra,0x0
    800017f4:	740080e7          	jalr	1856(ra) # 80001f30 <_ZN15MemoryAllocator8memAllocEv>
    TCB *threads[5];

    Riscv::w_stvec((uint64) &Riscv::supervisorTrap);
    800017f8:	00004797          	auipc	a5,0x4
    800017fc:	1787b783          	ld	a5,376(a5) # 80005970 <_GLOBAL_OFFSET_TABLE_+0x18>
...
inline void Riscv::w_stvec(uint64 stvec) {
    ...
    80001800:	10579073          	csrw	stvec,a5

    thread_create(&threads[0], nullptr, nullptr);
    80001804:	00000613          	li	a2,0
    80001808:	00000593          	li	a1,0
    8000180c:	fb840513          	addi	a0,s0,-72
    80001810:	00000097          	auipc	ra,0x0
    80001814:	a84080e7          	jalr	-1404(ra) # 80001294 <_Z13thread_createPP3TCBPFvPvES2_>
    TCB::running = threads[0];
    80001818:	fb843703          	ld	a4,-72(s0)
    8000181c:	00004797          	auipc	a5,0x4
    80001820:	1747b783          	ld	a5,372(a5) # 80005990 <_GLOBAL_OFFSET_TABLE_+0x38>
    80001824:	00e7b023          	sd	a4,0(a5)
    thread_create(&threads[1], workerBodyA, nullptr);
    80001828:	00000613          	li	a2,0
    8000182c:	00004597          	auipc	a1,0x4
    80001830:	15c5b583          	ld	a1,348(a1) # 80005988 <_GLOBAL_OFFSET_TABLE_+0x30>
    80001834:	fc040513          	addi	a0,s0,-64
    80001838:	00000097          	auipc	ra,0x0
    8000183c:	a5c080e7          	jalr	-1444(ra) # 80001294 <_Z13thread_createPP3TCBPFvPvES2_>
    printString("ThreadA created\n");
    80001840:	00004517          	auipc	a0,0x4
    80001844:	84850513          	addi	a0,a0,-1976 # 80005088 <CONSOLE_STATUS+0x78>
    80001848:	00001097          	auipc	ra,0x1
    8000184c:	964080e7          	jalr	-1692(ra) # 800021ac <_Z11printStringPKc>
    thread_create(&threads[2], workerBodyB, nullptr);
    80001850:	00000613          	li	a2,0
    80001854:	00004597          	auipc	a1,0x4
    80001858:	14c5b583          	ld	a1,332(a1) # 800059a0 <_GLOBAL_OFFSET_TABLE_+0x48>
    8000185c:	fc840513          	addi	a0,s0,-56
    80001860:	00000097          	auipc	ra,0x0
    80001864:	a34080e7          	jalr	-1484(ra) # 80001294 <_Z13thread_createPP3TCBPFvPvES2_>
    printString("ThreadB created\n");
    80001868:	00004517          	auipc	a0,0x4
    8000186c:	83850513          	addi	a0,a0,-1992 # 800050a0 <CONSOLE_STATUS+0x90>
    80001870:	00001097          	auipc	ra,0x1
    80001874:	93c080e7          	jalr	-1732(ra) # 800021ac <_Z11printStringPKc>
    thread_create(&threads[3], workerBodyC, nullptr);
    80001878:	00000613          	li	a2,0
    8000187c:	00004597          	auipc	a1,0x4
    80001880:	0ec5b583          	ld	a1,236(a1) # 80005968 <_GLOBAL_OFFSET_TABLE_+0x10>
    80001884:	fd040513          	addi	a0,s0,-48
    80001888:	00000097          	auipc	ra,0x0
    8000188c:	a0c080e7          	jalr	-1524(ra) # 80001294 <_Z13thread_createPP3TCBPFvPvES2_>
    printString("ThreadC created\n");
    80001890:	00004517          	auipc	a0,0x4
    80001894:	82850513          	addi	a0,a0,-2008 # 800050b8 <CONSOLE_STATUS+0xa8>
    80001898:	00001097          	auipc	ra,0x1
    8000189c:	914080e7          	jalr	-1772(ra) # 800021ac <_Z11printStringPKc>
    thread_create(&threads[4], workerBodyD, nullptr);
    800018a0:	00000613          	li	a2,0
    800018a4:	00004597          	auipc	a1,0x4
    800018a8:	1045b583          	ld	a1,260(a1) # 800059a8 <_GLOBAL_OFFSET_TABLE_+0x50>
    800018ac:	fd840513          	addi	a0,s0,-40
    800018b0:	00000097          	auipc	ra,0x0
    800018b4:	9e4080e7          	jalr	-1564(ra) # 80001294 <_Z13thread_createPP3TCBPFvPvES2_>
    printString("ThreadD created\n");
    800018b8:	00004517          	auipc	a0,0x4
    800018bc:	81850513          	addi	a0,a0,-2024 # 800050d0 <CONSOLE_STATUS+0xc0>
    800018c0:	00001097          	auipc	ra,0x1
    800018c4:	8ec080e7          	jalr	-1812(ra) # 800021ac <_Z11printStringPKc>
...
inline void Riscv::ms_sstatus(uint64 mask) {
    ...
    800018cc:	1007a073          	csrs	sstatus,a5
}
    800018d0:	00c0006f          	j	800018dc <main+0x104>
    ...
    800018d8:	1b8080e7          	jalr	440(ra) # 80001a8c <_ZN3TCB5yieldEv>
    while (!(threads[1]->isFinished() && threads[2]->isFinished() &&
    800018dc:	fc043783          	ld	a5,-64(s0)
#include "../lib/hw.h"
...
class TCB {
    ...
    800018e0:	0287c783          	lbu	a5,40(a5)
    800018e4:	fe0788e3          	beqz	a5,800018d4 <main+0xfc>
    800018e8:	fc843783          	ld	a5,-56(s0)
    800018ec:	0287c783          	lbu	a5,40(a5)
    800018f0:	fe0782e3          	beqz	a5,800018d4 <main+0xfc>
             threads[3]->isFinished() && threads[4]->isFinished())) {
    800018f4:	fd043783          	ld	a5,-48(s0)
    800018f8:	0287c783          	lbu	a5,40(a5)
    while (!(threads[1]->isFinished() && threads[2]->isFinished() &&
    800018fc:	fc078ce3          	beqz	a5,800018d4 <main+0xfc>
             threads[3]->isFinished() && threads[4]->isFinished())) {
    80001900:	fd843783          	ld	a5,-40(s0)
    80001904:	0287c783          	lbu	a5,40(a5)
    while (!(threads[1]->isFinished() && threads[2]->isFinished() &&
    80001908:	fc0786e3          	beqz	a5,800018d4 <main+0xfc>
    8000190c:	fb840493          	addi	s1,s0,-72
    80001910:	0140006f          	j	80001924 <main+0x14c>
    }
    for (auto &thread: threads) { delete thread; }
    80001914:	00090513          	mv	a0,s2
    80001918:	00000097          	auipc	ra,0x0
    8000191c:	2b8080e7          	jalr	696(ra) # 80001bd0 <_ZdlPv>
    80001920:	00848493          	addi	s1,s1,8
    80001924:	fe040793          	addi	a5,s0,-32
    80001928:	02f48063          	beq	s1,a5,80001948 <main+0x170>
    8000192c:	0004b903          	ld	s2,0(s1)
    80001930:	fe0908e3          	beqz	s2,80001920 <main+0x148>
        ~TCB() { delete[] stack; }
    80001934:	00893503          	ld	a0,8(s2)
    80001938:	fc050ee3          	beqz	a0,80001914 <main+0x13c>
    8000193c:	00000097          	auipc	ra,0x0
    80001940:	2bc080e7          	jalr	700(ra) # 80001bf8 <_ZdaPv>
    80001944:	fd1ff06f          	j	80001914 <main+0x13c>
    ...
    80001954:	85c080e7          	jalr	-1956(ra) # 800021ac <_Z11printStringPKc>
    return 0;
}
    80001958:	00000513          	li	a0,0
    8000195c:	04813083          	ld	ra,72(sp)
    80001960:	04013403          	ld	s0,64(sp)
    80001964:	03813483          	ld	s1,56(sp)
    80001968:	03013903          	ld	s2,48(sp)
    8000196c:	05010113          	addi	sp,sp,80
    80001970:	00008067          	ret

0000000080001974 <_ZN3TCBC1EPFvvEm>:
...
TCB::TCB(Body body, uint64 timeSlice) : body(body),
    ...
    80001978:	02113423          	sd	ra,40(sp)
    8000197c:	02813023          	sd	s0,32(sp)
    80001980:	00913c23          	sd	s1,24(sp)
    80001984:	01213823          	sd	s2,16(sp)
    80001988:	01313423          	sd	s3,8(sp)
    8000198c:	03010413          	addi	s0,sp,48
    80001990:	00050493          	mv	s1,a0
    80001994:	00058913          	mv	s2,a1
    80001998:	00060993          	mv	s3,a2
...
stack(body != nullptr ? new uint64[STACK_SIZE] : nullptr),
    800019a0:	06058263          	beqz	a1,80001a04 <_ZN3TCBC1EPFvvEm+0x90>
    800019a4:	00002537          	lui	a0,0x2
    800019a8:	00000097          	auipc	ra,0x0
    800019ac:	200080e7          	jalr	512(ra) # 80001ba8 <_Znam>
finished(false) { if (body != nullptr) { Scheduler::put(this); } }
    800019b0:	00a4b423          	sd	a0,8(s1)
    800019b4:	00000797          	auipc	a5,0x0
    800019b8:	0f478793          	addi	a5,a5,244 # 80001aa8 <_ZN3TCB13threadWrapperEv>
    800019bc:	00f4b823          	sd	a5,16(s1)
         stack != nullptr ? (uint64) &stack[STACK_SIZE] : 0 }),
    800019c0:	04050663          	beqz	a0,80001a0c <_ZN3TCBC1EPFvvEm+0x98>
    800019c4:	000027b7          	lui	a5,0x2
    800019c8:	00f50533          	add	a0,a0,a5
finished(false) { if (body != nullptr) { Scheduler::put(this); } }
    800019cc:	00a4bc23          	sd	a0,24(s1)
    800019d0:	0334b023          	sd	s3,32(s1)
    800019d4:	02048423          	sb	zero,40(s1)
    800019d8:	00090863          	beqz	s2,800019e8 <_ZN3TCBC1EPFvvEm+0x74>
    800019dc:	00048513          	mv	a0,s1
    800019e0:	00000097          	auipc	ra,0x0
    800019e4:	4b0080e7          	jalr	1200(ra) # 80001e90 <_ZN9Scheduler3putEP3TCB>
    800019e8:	02813083          	ld	ra,40(sp)
    800019ec:	02013403          	ld	s0,32(sp)
    800019f0:	01813483          	ld	s1,24(sp)
    800019f4:	01013903          	ld	s2,16(sp)
    800019f8:	00813983          	ld	s3,8(sp)
    800019fc:	03010113          	addi	sp,sp,48
    80001a00:	00008067          	ret
stack(body != nullptr ? new uint64[STACK_SIZE] : nullptr),
    80001a04:	00000513          	li	a0,0
    80001a08:	fa9ff06f          	j	800019b0 <_ZN3TCBC1EPFvvEm+0x3c>
         stack != nullptr ? (uint64) &stack[STACK_SIZE] : 0 }),
    80001a0c:	00000513          	li	a0,0
    80001a10:	fbdff06f          	j	800019cc <_ZN3TCBC1EPFvvEm+0x58>

0000000080001a14 <_ZN3TCB12createThreadEPFvvE>:
...
TCB *TCB::createThread(Body body) {
    ...
    80001a30:	03000513          	li	a0,48
    80001a34:	00000097          	auipc	ra,0x0
    80001a38:	14c080e7          	jalr	332(ra) # 80001b80 <_Znwm>
    80001a3c:	00050493          	mv	s1,a0
    80001a40:	00200613          	li	a2,2
    80001a44:	00090593          	mv	a1,s2
    80001a48:	00000097          	auipc	ra,0x0
    80001a4c:	f2c080e7          	jalr	-212(ra) # 80001974 <_ZN3TCBC1EPFvvEm>
    80001a50:	0200006f          	j	80001a70 <_ZN3TCB12createThreadEPFvvE+0x5c>
    80001a54:	00050913          	mv	s2,a0
    80001a58:	00048513          	mv	a0,s1
    80001a5c:	00000097          	auipc	ra,0x0
    80001a60:	174080e7          	jalr	372(ra) # 80001bd0 <_ZdlPv>
    80001a64:	00090513          	mv	a0,s2
    80001a68:	00005097          	auipc	ra,0x5
    80001a6c:	090080e7          	jalr	144(ra) # 80006af8 <_Unwind_Resume>
}
...
0000000080001a8c <_ZN3TCB5yieldEv>:
...
void TCB::yield() { __asm__ volatile ("ecall"); }
    ...
    80001a98:	00000073          	ecall
    80001a9c:	00813403          	ld	s0,8(sp)
    80001aa0:	01010113          	addi	sp,sp,16
    80001aa4:	00008067          	ret

0000000080001aa8 <_ZN3TCB13threadWrapperEv>:
...
void TCB::threadWrapper() {
    ...
    80001ac0:	164080e7          	jalr	356(ra) # 80001c20 <_ZN5Riscv10popSppSpieEv>
    running->body();
    80001ac4:	00004497          	auipc	s1,0x4
    80001ac8:	f3c48493          	addi	s1,s1,-196 # 80005a00 <_ZN3TCB7runningE>
    80001acc:	0004b783          	ld	a5,0(s1)
    80001ad0:	0007b783          	ld	a5,0(a5) # 2000 <_entry-0x7fffe000>
    80001ad4:	000780e7          	jalr	a5
    running->setFinished(true);
    80001ad8:	0004b783          	ld	a5,0(s1)
        void setFinished(bool value) { finished = value; }
    80001adc:	00100713          	li	a4,1
    80001ae0:	02e78423          	sb	a4,40(a5)
    TCB::yield();
    80001ae4:	00000097          	auipc	ra,0x0
    80001ae8:	fa8080e7          	jalr	-88(ra) # 80001a8c <_ZN3TCB5yieldEv>
}
...
0000000080001b00 <_ZN3TCB8dispatchEv>:
void TCB::dispatch() {
    ...
    80001b1c:	ee84b483          	ld	s1,-280(s1) # 80005a00 <_ZN3TCB7runningE>
...
inline uint64 Riscv::r_sstatus() {
    ...
    80001b24:	fcf43c23          	sd	a5,-40(s0)
    return sstatus;
    80001b28:	fd843903          	ld	s2,-40(s0)
        bool isFinished() const { return finished; }
    80001b2c:	0284c783          	lbu	a5,40(s1)
    if (!old->isFinished()) { Scheduler::put(old); }
    80001b30:	04078063          	beqz	a5,80001b70 <_ZN3TCB8dispatchEv+0x70>
    running = Scheduler::get();
    80001b34:	00000097          	auipc	ra,0x0
    80001b38:	2f4080e7          	jalr	756(ra) # 80001e28 <_ZN9Scheduler3getEv>
    80001b3c:	00004797          	auipc	a5,0x4
    80001b40:	eca7b223          	sd	a0,-316(a5) # 80005a00 <_ZN3TCB7runningE>
}
inline void Riscv::w_sstatus(uint64 sstatus) {
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001b44:	10091073          	csrw	sstatus,s2
    TCB::contextSwitch(&old->context, &running->context);
    80001b48:	01050593          	addi	a1,a0,16 # 2010 <_entry-0x7fffdff0>
    80001b4c:	01048513          	addi	a0,s1,16
    80001b50:	fffff097          	auipc	ra,0xfffff
    80001b54:	6d0080e7          	jalr	1744(ra) # 80001220 <_ZN3TCB13contextSwitchEPNS_7ContextES1_>
}
    ...
    80001b78:	31c080e7          	jalr	796(ra) # 80001e90 <_ZN9Scheduler3putEP3TCB>
    80001b7c:	fb9ff06f          	j	80001b34 <_ZN3TCB8dispatchEv+0x34>

0000000080001b80 <_Znwm>:
//
#include "../lib/mem.h"
#include "../h/MemoryAllocator.hpp"
#include "../h/syscall_c.hpp"
...
void Riscv::handleSupervisorTrap() {
    80001c40:	fa010113          	addi	sp,sp,-96
    80001c44:	04113c23          	sd	ra,88(sp)
    80001c48:	04813823          	sd	s0,80(sp)
    80001c4c:	04913423          	sd	s1,72(sp)
    80001c50:	05213023          	sd	s2,64(sp)
    80001c54:	06010413          	addi	s0,sp,96
    __asm__ volatile ("csrr %[scause], scause" : [scause] "=r"(scause));
    80001c58:	142027f3          	csrr	a5,scause
    80001c5c:	faf43423          	sd	a5,-88(s0)
    return scause;
    80001c60:	fa843703          	ld	a4,-88(s0)
    ...
    80001c68:	00078663          	beqz	a5,80001c74 <_ZN5Riscv20handleSupervisorTrapEv+0x34>
    80001c6c:	00900693          	li	a3,9
    80001c70:	04d70263          	beq	a4,a3,80001cb4 <_ZN5Riscv20handleSupervisorTrapEv+0x74>
        }
    ...
    80001c78:	0af70e63          	beq	a4,a5,80001d34 <_ZN5Riscv20handleSupervisorTrapEv+0xf4>
    ...
    80001c88:	0ef70463          	beq	a4,a5,80001d70 <_ZN5Riscv20handleSupervisorTrapEv+0x130>
            TCB::timeSliceCounter = 0;
            TCB::dispatch();
            w_sstatus(sstatus); w_sepc(sepc);
        }
    ...
    80001c98:	14f70263          	beq	a4,a5,80001ddc <_ZN5Riscv20handleSupervisorTrapEv+0x19c>
        console_handler();
    } else {
    ...
    80001c9c:	05813083          	ld	ra,88(sp)
    80001ca0:	05013403          	ld	s0,80(sp)
    80001ca4:	04813483          	ld	s1,72(sp)
    80001ca8:	04013903          	ld	s2,64(sp)
    80001cac:	06010113          	addi	sp,sp,96
    80001cb0:	00008067          	ret
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001cb4:	14102773          	csrr	a4,sepc
    80001cb8:	fae43c23          	sd	a4,-72(s0)
    return sepc;
    80001cbc:	fb843483          	ld	s1,-72(s0)
        uint64 sepc = r_sepc() + 4; uint64 sstatus = r_sstatus();
    80001cc0:	00448493          	addi	s1,s1,4
    __asm__ volatile ("csrr %[sstatus], sstatus" : [sstatus] "=r"(sstatus));
    80001cc4:	10002773          	csrr	a4,sstatus
    80001cc8:	fae43823          	sd	a4,-80(s0)
    return sstatus;
    80001ccc:	fb043903          	ld	s2,-80(s0)
        if(argument0 == 1){ // syscall za mem_alloc
    80001cd0:	00100713          	li	a4,1
    80001cd4:	02e78063          	beq	a5,a4,80001cf4 <_ZN5Riscv20handleSupervisorTrapEv+0xb4>
        }else if(argument0 == 2){ // sistemski poziv za mem_free
    80001cd8:	00200713          	li	a4,2
    80001cdc:	02e78663          	beq	a5,a4,80001d08 <_ZN5Riscv20handleSupervisorTrapEv+0xc8>
        }else if(argument0 == 11){
    80001ce0:	00b00713          	li	a4,11
    80001ce4:	02e78a63          	beq	a5,a4,80001d18 <_ZN5Riscv20handleSupervisorTrapEv+0xd8>
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001ce8:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001cec:	14149073          	csrw	sepc,s1
}
    80001cf0:	fadff06f          	j	80001c9c <_ZN5Riscv20handleSupervisorTrapEv+0x5c>
    ...
    80001cfc:	288080e7          	jalr	648(ra) # 80001f80 <_ZN15MemoryAllocator9mem_allocEm>
            __asm__ volatile("mv a0, %0" : : "r" (argument_ret_void));
    80001d00:	00050513          	mv	a0,a0
    80001d04:	fe5ff06f          	j	80001ce8 <_ZN5Riscv20handleSupervisorTrapEv+0xa8>
            __asm__ volatile("mv %0, a1" : "=r" (argument_void));
    80001d08:	00058513          	mv	a0,a1
            MemoryAllocator::mem_free(argument_void);
    80001d0c:	00000097          	auipc	ra,0x0
    80001d10:	3b4080e7          	jalr	948(ra) # 800020c0 <_ZN15MemoryAllocator8mem_freeEPv>
    80001d14:	fd5ff06f          	j	80001ce8 <_ZN5Riscv20handleSupervisorTrapEv+0xa8>
            __asm__ volatile("mv %0, a1" : "=r" (handler));
    80001d18:	00058793          	mv	a5,a1
            __asm__ volatile("mv %0, a2" : "=r" (sr));
    80001d1c:	00060513          	mv	a0,a2
            __asm__ volatile("mv %0, a3" : "=r" (arg));
    80001d20:	00068793          	mv	a5,a3
            handler = TCB::createThread(sr);
    80001d24:	00000097          	auipc	ra,0x0
    80001d28:	cf0080e7          	jalr	-784(ra) # 80001a14 <_ZN3TCB12createThreadEPFvvE>
            __asm__ volatile("mv a0, %0" : : "r" (handler));
    80001d2c:	00050513          	mv	a0,a0
    80001d30:	fb9ff06f          	j	80001ce8 <_ZN5Riscv20handleSupervisorTrapEv+0xa8>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001d34:	141027f3          	csrr	a5,sepc
    80001d38:	fcf43423          	sd	a5,-56(s0)
    return sepc;
    80001d3c:	fc843483          	ld	s1,-56(s0)
        uint64 sepc = r_sepc() + 4; uint64 sstatus = r_sstatus();
    80001d40:	00448493          	addi	s1,s1,4
    __asm__ volatile ("csrr %[sstatus], sstatus" : [sstatus] "=r"(sstatus));
    80001d44:	100027f3          	csrr	a5,sstatus
    80001d48:	fcf43023          	sd	a5,-64(s0)
    return sstatus;
    80001d4c:	fc043903          	ld	s2,-64(s0)
        TCB::timeSliceCounter = 0;
    80001d50:	00004797          	auipc	a5,0x4
    80001d54:	c287b783          	ld	a5,-984(a5) # 80005978 <_GLOBAL_OFFSET_TABLE_+0x20>
    80001d58:	0007b023          	sd	zero,0(a5)
        TCB::dispatch();
    80001d5c:	00000097          	auipc	ra,0x0
    80001d60:	da4080e7          	jalr	-604(ra) # 80001b00 <_ZN3TCB8dispatchEv>
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001d64:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001d68:	14149073          	csrw	sepc,s1
}
    80001d6c:	f31ff06f          	j	80001c9c <_ZN5Riscv20handleSupervisorTrapEv+0x5c>
        TCB::timeSliceCounter++;
    80001d70:	00004717          	auipc	a4,0x4
    80001d74:	c0873703          	ld	a4,-1016(a4) # 80005978 <_GLOBAL_OFFSET_TABLE_+0x20>
    80001d78:	00073783          	ld	a5,0(a4)
    80001d7c:	00178793          	addi	a5,a5,1
    80001d80:	00f73023          	sd	a5,0(a4)
        if (TCB::timeSliceCounter >= TCB::running->getTimeSlice()) {
    80001d84:	00004717          	auipc	a4,0x4
    80001d88:	c0c73703          	ld	a4,-1012(a4) # 80005990 <_GLOBAL_OFFSET_TABLE_+0x38>
    80001d8c:	00073703          	ld	a4,0(a4)
        uint64 getTimeSlice() const { return timeSlice; }
    80001d90:	02073703          	ld	a4,32(a4)
    80001d94:	00e7f863          	bgeu	a5,a4,80001da4 <_ZN5Riscv20handleSupervisorTrapEv+0x164>
    __asm__ volatile ("csrc sip, %[mask]" : : [mask] "r"(mask));
    80001d98:	00200793          	li	a5,2
    80001d9c:	1447b073          	csrc	sip,a5
}
    80001da0:	efdff06f          	j	80001c9c <_ZN5Riscv20handleSupervisorTrapEv+0x5c>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001da4:	141027f3          	csrr	a5,sepc
    80001da8:	fcf43c23          	sd	a5,-40(s0)
    return sepc;
    80001dac:	fd843483          	ld	s1,-40(s0)
    __asm__ volatile ("csrr %[sstatus], sstatus" : [sstatus] "=r"(sstatus));
    80001db0:	100027f3          	csrr	a5,sstatus
    80001db4:	fcf43823          	sd	a5,-48(s0)
    return sstatus;
    80001db8:	fd043903          	ld	s2,-48(s0)
            TCB::timeSliceCounter = 0;
    80001dbc:	00004797          	auipc	a5,0x4
    80001dc0:	bbc7b783          	ld	a5,-1092(a5) # 80005978 <_GLOBAL_OFFSET_TABLE_+0x20>
    80001dc4:	0007b023          	sd	zero,0(a5)
            TCB::dispatch();
    80001dc8:	00000097          	auipc	ra,0x0
    80001dcc:	d38080e7          	jalr	-712(ra) # 80001b00 <_ZN3TCB8dispatchEv>
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001dd0:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001dd4:	14149073          	csrw	sepc,s1
}
    80001dd8:	fc1ff06f          	j	80001d98 <_ZN5Riscv20handleSupervisorTrapEv+0x158>
        console_handler();
    80001ddc:	00002097          	auipc	ra,0x2
    80001de0:	604080e7          	jalr	1540(ra) # 800043e0 <console_handler>
}
    80001de4:	eb9ff06f          	j	80001c9c <_ZN5Riscv20handleSupervisorTrapEv+0x5c>

0000000080001de8 <_Z41__static_initialization_and_destruction_0ii>:
...
void Scheduler::put(TCB *tcb) {
    ...
    80001df8:	00f50863          	beq	a0,a5,80001e08 <_Z41__static_initialization_and_destruction_0ii+0x20>
    80001dfc:	00813403          	ld	s0,8(sp)
    80001e00:	01010113          	addi	sp,sp,16
    80001e04:	00008067          	ret
    80001e08:	000107b7          	lui	a5,0x10
    80001e0c:	fff78793          	addi	a5,a5,-1 # ffff <_entry-0x7fff0001>
    80001e10:	fef596e3          	bne	a1,a5,80001dfc <_Z41__static_initialization_and_destruction_0ii+0x14>
...
public:
    ...
    80001e18:	bfc78793          	addi	a5,a5,-1028 # 80005a10 <_ZN9Scheduler19readyCoroutineQueueE>
    80001e1c:	0007b023          	sd	zero,0(a5)
    80001e20:	0007b423          	sd	zero,8(a5)
    80001e24:	fd9ff06f          	j	80001dfc <_Z41__static_initialization_and_destruction_0ii+0x14>

0000000080001e28 <_ZN9Scheduler3getEv>:
TCB *Scheduler::get() {
    ...
    80001e40:	bd453503          	ld	a0,-1068(a0) # 80005a10 <_ZN9Scheduler19readyCoroutineQueueE>
    80001e44:	04050263          	beqz	a0,80001e88 <_ZN9Scheduler3getEv+0x60>

        Elem *elem = head;
        head = head->next;
    80001e48:	00853783          	ld	a5,8(a0)
    80001e4c:	00004717          	auipc	a4,0x4
    80001e50:	bcf73223          	sd	a5,-1084(a4) # 80005a10 <_ZN9Scheduler19readyCoroutineQueueE>
        if(!head){ tail = 0; }
    80001e54:	02078463          	beqz	a5,80001e7c <_ZN9Scheduler3getEv+0x54>

        T *ret = elem->data;
    80001e58:	00053483          	ld	s1,0(a0)
        delete elem;
    80001e5c:	00000097          	auipc	ra,0x0
    80001e60:	d74080e7          	jalr	-652(ra) # 80001bd0 <_ZdlPv>
}
    ...
    80001e80:	b807be23          	sd	zero,-1124(a5) # 80005a18 <_ZN9Scheduler19readyCoroutineQueueE+0x8>
    80001e84:	fd5ff06f          	j	80001e58 <_ZN9Scheduler3getEv+0x30>
        if(!head){ return 0; }
    80001e88:	00050493          	mv	s1,a0
    return readyCoroutineQueue.removeFirst();
    80001e8c:	fd9ff06f          	j	80001e64 <_ZN9Scheduler3getEv+0x3c>

0000000080001e90 <_ZN9Scheduler3putEP3TCB>:
void Scheduler::put(TCB *tcb) {
    ...
    80001ea8:	01000513          	li	a0,16
    80001eac:	00000097          	auipc	ra,0x0
    80001eb0:	cd4080e7          	jalr	-812(ra) # 80001b80 <_Znwm>
        Elem(T *data, Elem *next) : data(data), next(next){}
    80001eb4:	00953023          	sd	s1,0(a0)
    80001eb8:	00053423          	sd	zero,8(a0)
        if(tail){
    80001ebc:	00004797          	auipc	a5,0x4
    80001ec0:	b5c7b783          	ld	a5,-1188(a5) # 80005a18 <_ZN9Scheduler19readyCoroutineQueueE+0x8>
    80001ec4:	02078263          	beqz	a5,80001ee8 <_ZN9Scheduler3putEP3TCB+0x58>
            tail->next = elem;
    80001ec8:	00a7b423          	sd	a0,8(a5)
            tail = elem;
    80001ecc:	00004797          	auipc	a5,0x4
    80001ed0:	b4a7b623          	sd	a0,-1204(a5) # 80005a18 <_ZN9Scheduler19readyCoroutineQueueE+0x8>
    ...
    80001eec:	b2878793          	addi	a5,a5,-1240 # 80005a10 <_ZN9Scheduler19readyCoroutineQueueE>
    80001ef0:	00a7b423          	sd	a0,8(a5)
    80001ef4:	00a7b023          	sd	a0,0(a5)
    80001ef8:	fddff06f          	j	80001ed4 <_ZN9Scheduler3putEP3TCB+0x44>

0000000080001efc <_GLOBAL__sub_I__ZN9Scheduler19readyCoroutineQueueE>:
    80001efc:	ff010113          	addi	sp,sp,-16
    80001f00:	00113423          	sd	ra,8(sp)
    80001f04:	00813023          	sd	s0,0(sp)
    80001f08:	01010413          	addi	s0,sp,16
    80001f0c:	000105b7          	lui	a1,0x10
    80001f10:	fff58593          	addi	a1,a1,-1 # ffff <_entry-0x7fff0001>
    80001f14:	00100513          	li	a0,1
    80001f18:	00000097          	auipc	ra,0x0
    80001f1c:	ed0080e7          	jalr	-304(ra) # 80001de8 <_Z41__static_initialization_and_destruction_0ii>
    80001f20:	00813083          	ld	ra,8(sp)
    80001f24:	00013403          	ld	s0,0(sp)
    80001f28:	01010113          	addi	sp,sp,16
    80001f2c:	00008067          	ret

0000000080001f30 <_ZN15MemoryAllocator8memAllocEv>:
...
void MemoryAllocator::memAlloc(){
    ...
    80001f40:	a247b783          	ld	a5,-1500(a5) # 80005960 <_GLOBAL_OFFSET_TABLE_+0x8>
    80001f44:	0007b703          	ld	a4,0(a5)
    80001f48:	00004797          	auipc	a5,0x4
    80001f4c:	ad878793          	addi	a5,a5,-1320 # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    ...
    80001f58:	a446b683          	ld	a3,-1468(a3) # 80005998 <_GLOBAL_OFFSET_TABLE_+0x40>
    80001f5c:	0006b683          	ld	a3,0(a3)
    80001f60:	40e686b3          	sub	a3,a3,a4
    80001f64:	00d73023          	sd	a3,0(a4)
    freeMemBlocHead->next = nullptr;
    80001f68:	0007b703          	ld	a4,0(a5)
    80001f6c:	00073423          	sd	zero,8(a4)

    takenMemBlocHead = nullptr;
    80001f70:	0007b423          	sd	zero,8(a5)
}
    80001f74:	00813403          	ld	s0,8(sp)
    80001f78:	01010113          	addi	sp,sp,16
    80001f7c:	00008067          	ret

0000000080001f80 <_ZN15MemoryAllocator9mem_allocEm>:
...
void* MemoryAllocator::mem_alloc (size_t size){
    ...
    80001f8c:	04000793          	li	a5,64
    80001f90:	02a7fa63          	bgeu	a5,a0,80001fc4 <_ZN15MemoryAllocator9mem_allocEm+0x44>
        newSize = ((size / MEM_BLOCK_SIZE) + 1) * MEM_BLOCK_SIZE + sizeof(MemoryBloc);
    80001f94:	00655713          	srli	a4,a0,0x6
    80001f98:	00170713          	addi	a4,a4,1
    80001f9c:	00671713          	slli	a4,a4,0x6
    80001fa0:	01070713          	addi	a4,a4,16
    }else{
    ...
    80001fa4:	00004617          	auipc	a2,0x4
    80001fa8:	a7c63603          	ld	a2,-1412(a2) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80001fac:	00060513          	mv	a0,a2

    while(newSize > curr->size && curr != nullptr){
    80001fb0:	00053783          	ld	a5,0(a0)
    80001fb4:	00e7fc63          	bgeu	a5,a4,80001fcc <_ZN15MemoryAllocator9mem_allocEm+0x4c>
    80001fb8:	00050a63          	beqz	a0,80001fcc <_ZN15MemoryAllocator9mem_allocEm+0x4c>
        curr = curr->next;
    80001fbc:	00853503          	ld	a0,8(a0)
    while(newSize > curr->size && curr != nullptr){
    80001fc0:	ff1ff06f          	j	80001fb0 <_ZN15MemoryAllocator9mem_allocEm+0x30>
        newSize = MEM_BLOCK_SIZE + sizeof(MemoryBloc);
    80001fc4:	05000713          	li	a4,80
    80001fc8:	fddff06f          	j	80001fa4 <_ZN15MemoryAllocator9mem_allocEm+0x24>
    }

    if(curr == nullptr){
    80001fcc:	00051863          	bnez	a0,80001fdc <_ZN15MemoryAllocator9mem_allocEm+0x5c>
    ...
    80001fdc:	00c50e63          	beq	a0,a2,80001ff8 <_ZN15MemoryAllocator9mem_allocEm+0x78>
    bool checkFree = false;
    80001fe0:	00000593          	li	a1,0
    MemoryBloc* next = curr->next;
    80001fe4:	00853803          	ld	a6,8(a0)
    size_t currSize = curr->size - newSize;
    80001fe8:	40e786b3          	sub	a3,a5,a4
    if(currSize == 0){
    80001fec:	06e79663          	bne	a5,a4,80002058 <_ZN15MemoryAllocator9mem_allocEm+0xd8>
        MemoryBloc* currFree = freeMemBlocHead;
    80001ff0:	00060793          	mv	a5,a2
    80001ff4:	0100006f          	j	80002004 <_ZN15MemoryAllocator9mem_allocEm+0x84>
        checkFree = true;
    80001ff8:	00100593          	li	a1,1
    80001ffc:	fe9ff06f          	j	80001fe4 <_ZN15MemoryAllocator9mem_allocEm+0x64>
            currFree = currFree->next;
    80002000:	00068793          	mv	a5,a3
        while(currFree != nullptr && currFree->next != curr && checkFree != true){
    80002004:	00078863          	beqz	a5,80002014 <_ZN15MemoryAllocator9mem_allocEm+0x94>
    80002008:	0087b683          	ld	a3,8(a5)
    8000200c:	00a68463          	beq	a3,a0,80002014 <_ZN15MemoryAllocator9mem_allocEm+0x94>
    80002010:	fe0588e3          	beqz	a1,80002000 <_ZN15MemoryAllocator9mem_allocEm+0x80>
        if(currFree == freeMemBlocHead){
    80002014:	02c78a63          	beq	a5,a2,80002048 <_ZN15MemoryAllocator9mem_allocEm+0xc8>
            currFree->next = curr->next;
    80002018:	0107b423          	sd	a6,8(a5)
    newBloc->size = newSize;
    8000201c:	00e53023          	sd	a4,0(a0)
    if(takenMemBlocHead == nullptr){
    80002020:	00004697          	auipc	a3,0x4
    80002024:	a086b683          	ld	a3,-1528(a3) # 80005a28 <_ZN15MemoryAllocator16takenMemBlocHeadE>
    80002028:	06068263          	beqz	a3,8000208c <_ZN15MemoryAllocator9mem_allocEm+0x10c>
    ...
    80002034:	06a7f463          	bgeu	a5,a0,8000209c <_ZN15MemoryAllocator9mem_allocEm+0x11c>
    80002038:	06078263          	beqz	a5,8000209c <_ZN15MemoryAllocator9mem_allocEm+0x11c>
            prevTaken = nextTaken;
    8000203c:	00078713          	mv	a4,a5
            nextTaken = nextTaken->next;
    80002040:	0087b783          	ld	a5,8(a5)
        while (newBloc > nextTaken && nextTaken != nullptr){
    80002044:	ff1ff06f          	j	80002034 <_ZN15MemoryAllocator9mem_allocEm+0xb4>
            freeMemBlocHead = freeMemBlocHead->next;
    80002048:	00863783          	ld	a5,8(a2)
    8000204c:	00004697          	auipc	a3,0x4
    80002050:	9cf6ba23          	sd	a5,-1580(a3) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002054:	fc9ff06f          	j	8000201c <_ZN15MemoryAllocator9mem_allocEm+0x9c>
    }else if(checkFree == true){
    80002058:	02058263          	beqz	a1,8000207c <_ZN15MemoryAllocator9mem_allocEm+0xfc>
        freeMemBlocHead = (MemoryBloc*)((char*)freeMemBlocHead + newSize);
    8000205c:	00e60633          	add	a2,a2,a4
    80002060:	00004797          	auipc	a5,0x4
    80002064:	9c078793          	addi	a5,a5,-1600 # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002068:	00c7b023          	sd	a2,0(a5)
        freeMemBlocHead->size = currSize;
    8000206c:	00d63023          	sd	a3,0(a2)
        freeMemBlocHead->next = next;
    80002070:	0007b783          	ld	a5,0(a5)
    80002074:	0107b423          	sd	a6,8(a5)
    80002078:	fa5ff06f          	j	8000201c <_ZN15MemoryAllocator9mem_allocEm+0x9c>
        curr = (MemoryBloc*)((char*)curr + newSize);
    8000207c:	00e507b3          	add	a5,a0,a4
        curr->size = currSize;
    80002080:	00d7b023          	sd	a3,0(a5)
        curr->next = next;
    80002084:	0107b423          	sd	a6,8(a5)
    80002088:	f95ff06f          	j	8000201c <_ZN15MemoryAllocator9mem_allocEm+0x9c>
        takenMemBlocHead = newBloc;
    8000208c:	00004797          	auipc	a5,0x4
    80002090:	98a7be23          	sd	a0,-1636(a5) # 80005a28 <_ZN15MemoryAllocator16takenMemBlocHeadE>
        newBloc->next = nullptr;
    80002094:	00053423          	sd	zero,8(a0)
    80002098:	0100006f          	j	800020a8 <_ZN15MemoryAllocator9mem_allocEm+0x128>
        if(nextTaken == takenMemBlocHead){
    8000209c:	00f68a63          	beq	a3,a5,800020b0 <_ZN15MemoryAllocator9mem_allocEm+0x130>
            newBloc->next = nextTaken;
    800020a0:	00f53423          	sd	a5,8(a0)
            prevTaken->next = newBloc;
    800020a4:	00a73423          	sd	a0,8(a4)
    return (void*)((char*)newBloc + sizeof(MemoryBloc));
    800020a8:	01050513          	addi	a0,a0,16
    800020ac:	f25ff06f          	j	80001fd0 <_ZN15MemoryAllocator9mem_allocEm+0x50>
            newBloc->next = takenMemBlocHead;
    800020b0:	00d53423          	sd	a3,8(a0)
            takenMemBlocHead = newBloc;
    800020b4:	00004797          	auipc	a5,0x4
    800020b8:	96a7ba23          	sd	a0,-1676(a5) # 80005a28 <_ZN15MemoryAllocator16takenMemBlocHeadE>
    800020bc:	fedff06f          	j	800020a8 <_ZN15MemoryAllocator9mem_allocEm+0x128>

00000000800020c0 <_ZN15MemoryAllocator8mem_freeEPv>:
...
int MemoryAllocator::mem_free (void* mem){
    ...
    800020d0:	00004697          	auipc	a3,0x4
    800020d4:	9586b683          	ld	a3,-1704(a3) # 80005a28 <_ZN15MemoryAllocator16takenMemBlocHeadE>
    800020d8:	00068793          	mv	a5,a3
    MemoryBloc* prev = nullptr;
    800020dc:	00000713          	li	a4,0

    while (curr != freeCurr){
    800020e0:	00a78863          	beq	a5,a0,800020f0 <_ZN15MemoryAllocator8mem_freeEPv+0x30>
        prev = curr;
    800020e4:	00078713          	mv	a4,a5
        curr = curr->next;
    800020e8:	0087b783          	ld	a5,8(a5)
    while (curr != freeCurr){
    800020ec:	ff5ff06f          	j	800020e0 <_ZN15MemoryAllocator8mem_freeEPv+0x20>
    }
    // uraditi nepredvidjeno ponasanje ako hocu da dealociram nesto sto nisam alocirao
    if(curr == takenMemBlocHead){
    800020f0:	02d78863          	beq	a5,a3,80002120 <_ZN15MemoryAllocator8mem_freeEPv+0x60>
        takenMemBlocHead = takenMemBlocHead->next;
    }else{
        prev->next = curr->next;
    800020f4:	0087b683          	ld	a3,8(a5)
    800020f8:	00d73423          	sd	a3,8(a4)
    }

    if(freeMemBlocHead == nullptr){
    800020fc:	00004617          	auipc	a2,0x4
    80002100:	92463603          	ld	a2,-1756(a2) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002104:	02060663          	beqz	a2,80002130 <_ZN15MemoryAllocator8mem_freeEPv+0x70>
        freeMemBlocHead = curr;
    }else{
        MemoryBloc* currFree = freeMemBlocHead;
    80002108:	00060713          	mv	a4,a2
        MemoryBloc* prevFree = nullptr;
    8000210c:	00000693          	li	a3,0

        while(curr > currFree){
    80002110:	02f77663          	bgeu	a4,a5,8000213c <_ZN15MemoryAllocator8mem_freeEPv+0x7c>
            prevFree = currFree;
    80002114:	00070693          	mv	a3,a4
            currFree = currFree->next;
    80002118:	00873703          	ld	a4,8(a4)
        while(curr > currFree){
    8000211c:	ff5ff06f          	j	80002110 <_ZN15MemoryAllocator8mem_freeEPv+0x50>
        takenMemBlocHead = takenMemBlocHead->next;
    80002120:	0086b703          	ld	a4,8(a3)
    80002124:	00004697          	auipc	a3,0x4
    80002128:	90e6b223          	sd	a4,-1788(a3) # 80005a28 <_ZN15MemoryAllocator16takenMemBlocHeadE>
    8000212c:	fd1ff06f          	j	800020fc <_ZN15MemoryAllocator8mem_freeEPv+0x3c>
        freeMemBlocHead = curr;
    80002130:	00004717          	auipc	a4,0x4
    80002134:	8ef73823          	sd	a5,-1808(a4) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002138:	0100006f          	j	80002148 <_ZN15MemoryAllocator8mem_freeEPv+0x88>
        }

        if(currFree == freeMemBlocHead){
    8000213c:	00e60c63          	beq	a2,a4,80002154 <_ZN15MemoryAllocator8mem_freeEPv+0x94>
    ...
    80002140:	00e7b423          	sd	a4,8(a5)
            prevFree->next = curr;
    80002144:	00f6b423          	sd	a5,8(a3)
        }
    }

    MemoryBloc* currMemMerge = freeMemBlocHead;
    80002148:	00004797          	auipc	a5,0x4
    8000214c:	8d87b783          	ld	a5,-1832(a5) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002150:	0300006f          	j	80002180 <_ZN15MemoryAllocator8mem_freeEPv+0xc0>
            curr->next = freeMemBlocHead;
    80002154:	00c7b423          	sd	a2,8(a5)
            freeMemBlocHead = curr;
    80002158:	00004717          	auipc	a4,0x4
    8000215c:	8cf73423          	sd	a5,-1848(a4) # 80005a20 <_ZN15MemoryAllocator15freeMemBlocHeadE>
    80002160:	fe9ff06f          	j	80002148 <_ZN15MemoryAllocator8mem_freeEPv+0x88>
    ...
    80002164:	00073603          	ld	a2,0(a4)
    80002168:	00c686b3          	add	a3,a3,a2
    8000216c:	00d7b023          	sd	a3,0(a5)
            currMemMerge->next = currMemMerge->next->next;
    80002170:	00873703          	ld	a4,8(a4)
    80002174:	00e7b423          	sd	a4,8(a5)
    80002178:	00078713          	mv	a4,a5
    8000217c:	00070793          	mv	a5,a4
    while(currMemMerge){
    80002180:	00078e63          	beqz	a5,8000219c <_ZN15MemoryAllocator8mem_freeEPv+0xdc>
        if(currMemMerge->next != nullptr && (char*)currMemMerge + currMemMerge->size == (char*)currMemMerge->next){
    80002184:	0087b703          	ld	a4,8(a5)
    80002188:	fe070ae3          	beqz	a4,8000217c <_ZN15MemoryAllocator8mem_freeEPv+0xbc>
    8000218c:	0007b683          	ld	a3,0(a5)
    80002190:	00d78633          	add	a2,a5,a3
    80002194:	fec714e3          	bne	a4,a2,8000217c <_ZN15MemoryAllocator8mem_freeEPv+0xbc>
    80002198:	fcdff06f          	j	80002164 <_ZN15MemoryAllocator8mem_freeEPv+0xa4>
...
void printString(char const *string)
{
    ...
    800021e8:	188080e7          	jalr	392(ra) # 8000436c <__putc>
        string++;
...
void printInteger(uint64 integer){
    ...
    8000222c:	03010413          	addi	s0,sp,48
    neg = 0;
    if(integer < 0){
        neg = 1;
        x = -integer;
        ...
        x = integer;
    80002230:	0005051b          	sext.w	a0,a0
    }
    ...
    do{
        buf[i++] = digits[x%10];
    80002238:	00a00613          	li	a2,10
    8000223c:	02c5773b          	remuw	a4,a0,a2
    80002240:	02071693          	slli	a3,a4,0x20
    80002244:	0206d693          	srli	a3,a3,0x20
    80002248:	00003717          	auipc	a4,0x3
    8000224c:	eb070713          	addi	a4,a4,-336 # 800050f8 <_ZZ12printIntegermE6digits>
    80002250:	00d70733          	add	a4,a4,a3
    80002254:	00074703          	lbu	a4,0(a4)
    80002258:	fe040693          	addi	a3,s0,-32
    8000225c:	009687b3          	add	a5,a3,s1
    80002260:	0014849b          	addiw	s1,s1,1
    80002264:	fee78823          	sb	a4,-16(a5)
    }while((x /= 10) != 0);
    80002268:	0005071b          	sext.w	a4,a0
    8000226c:	02c5553b          	divuw	a0,a0,a2
    80002270:	00900793          	li	a5,9
    80002274:	fce7e2e3          	bltu	a5,a4,80002238 <_Z12printIntegerm+0x1c>
    if(neg){
        buf[i++] = '-';
    }
    while(--i >= 0)
    80002278:	fff4849b          	addiw	s1,s1,-1
    8000227c:	0004ce63          	bltz	s1,80002298 <_Z12printIntegerm+0x7c>
        __putc(buf[i]);
    80002280:	fe040793          	addi	a5,s0,-32
    80002284:	009787b3          	add	a5,a5,s1
    80002288:	ff07c503          	lbu	a0,-16(a5)
    8000228c:	00002097          	auipc	ra,0x2
    80002290:	0e0080e7          	jalr	224(ra) # 8000436c <__putc>
    80002294:	fe5ff06f          	j	80002278 <_Z12printIntegerm+0x5c>
    80002298:	02813083          	ld	ra,40(sp)
    8000229c:	02013403          	ld	s0,32(sp)
    800022a0:	01813483          	ld	s1,24(sp)
    800022a4:	03010113          	addi	sp,sp,48
...
00000000800022ac <start>:
    ...
    800022c0:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7fff7b6f>
    ...
    80002354:	6e070713          	addi	a4,a4,1760 # 80005a30 <timer_scratch>
...
00000000800023ac <timerinit>:
    ...
    800023f0:	64470713          	addi	a4,a4,1604 # 80005a30 <timer_scratch>
...
0000000080002438 <system_main>:
    ...
    80002458:	57c48493          	addi	s1,s1,1404 # 800059d0 <started>
...
0000000080002530 <mycpu>:
    ...
    80002550:	51450513          	addi	a0,a0,1300 # 80006a60 <cpus>
...
0000000080002560 <userinit>:
    ...
    80002578:	26430067          	jr	612(t1) # 800017d8 <main>
...
0000000080002610 <trapinit>:
    ...
    8000262c:	4b850513          	addi	a0,a0,1208 # 80006ae0 <tickslock>
...
00000000800027d8 <clockintr>:
    ...
    800027f0:	2f448493          	addi	s1,s1,756 # 80006ae0 <tickslock>
    ...
    80002804:	1d470713          	addi	a4,a4,468 # 800059d4 <ticks>
...
0000000080002c24 <consoleread>:
    ...
    80002c6c:	ea048493          	addi	s1,s1,-352 # 80006b08 <cons>
...
0000000080002db4 <consoleintr>:
    ...
    80002dd0:	d3c90913          	addi	s2,s2,-708 # 80006b08 <cons>
    ...
    80002e30:	cdc50513          	addi	a0,a0,-804 # 80006b08 <cons>
...
0000000080002e48 <consoleinit>:
    ...
    80002e60:	cac48493          	addi	s1,s1,-852 # 80006b08 <cons>
...
0000000080002eac <console_read>:
    ...
    80002ec0:	d0433303          	ld	t1,-764(t1) # 80006bc0 <devsw+0x10>
...
0000000080002ecc <console_write>:
    ...
    80002ee0:	cec33303          	ld	t1,-788(t1) # 80006bc8 <devsw+0x18>
...
0000000080002eec <panic>:
    ...
    80002f10:	d407ae23          	sw	zero,-676(a5) # 80006c68 <pr+0x18>
    ...
    80002f40:	a8f72e23          	sw	a5,-1380(a4) # 800059d8 <panicked>
...
0000000080002f48 <__printf>:
    ...
    80002f88:	ccc30313          	addi	t1,t1,-820 # 80006c50 <pr>
    ...
    80003398:	8bc50513          	addi	a0,a0,-1860 # 80006c50 <pr>
...
00000000800035dc <printfinit>:
    ...
    800035f4:	66048493          	addi	s1,s1,1632 # 80006c50 <pr>
...
0000000080003668 <uartputc>:
    ...
    8000366c:	3707a783          	lw	a5,880(a5) # 800059d8 <panicked>
    ...
    80003698:	34c90913          	addi	s2,s2,844 # 800059e0 <uart_tx_r>
    8000369c:	00093783          	ld	a5,0(s2)
    800036a0:	00002497          	auipc	s1,0x2
    800036a4:	34848493          	addi	s1,s1,840 # 800059e8 <uart_tx_w>
    ...
    800036f4:	58058593          	addi	a1,a1,1408 # 80006c70 <uart_tx_buf>
...
0000000080003760 <uartputc_sync>:
    ...
    80003770:	26c72703          	lw	a4,620(a4) # 800059d8 <panicked>
...
00000000800037a4 <uartstart>:
    ...
    800037b4:	23060613          	addi	a2,a2,560 # 800059e0 <uart_tx_r>
    800037b8:	00002517          	auipc	a0,0x2
    800037bc:	23050513          	addi	a0,a0,560 # 800059e8 <uart_tx_w>
    ...
    800037d4:	4a080813          	addi	a6,a6,1184 # 80006c70 <uart_tx_buf>
...
0000000080003850 <uartintr>:
    ...
    80003898:	14c60613          	addi	a2,a2,332 # 800059e0 <uart_tx_r>
    8000389c:	00002517          	auipc	a0,0x2
    800038a0:	14c50513          	addi	a0,a0,332 # 800059e8 <uart_tx_w>
    ...
    800038b8:	3bc80813          	addi	a6,a6,956 # 80006c70 <uart_tx_buf>
    ...
    80003908:	0dc60613          	addi	a2,a2,220 # 800059e0 <uart_tx_r>
    8000390c:	00002517          	auipc	a0,0x2
    80003910:	0dc50513          	addi	a0,a0,220 # 800059e8 <uart_tx_w>
    ...
    80003928:	34c80813          	addi	a6,a6,844 # 80006c70 <uart_tx_buf>
...
0000000080003968 <kinit>:
    ...
    80003978:	31b48493          	addi	s1,s1,795 # 80007c8f <end+0xfff>
    ...
    800039b4:	2e0a8a93          	addi	s5,s5,736 # 80006c90 <end>
    ...
    800039cc:	02890913          	addi	s2,s2,40 # 800059f0 <kmem>
...
0000000080003a40 <freerange>:
    ...
    80003a88:	20ca8a93          	addi	s5,s5,524 # 80006c90 <end>
    ...
    80003aa4:	f5090913          	addi	s2,s2,-176 # 800059f0 <kmem>
...
0000000080003b20 <kfree>:
    ...
    80003b40:	15478793          	addi	a5,a5,340 # 80006c90 <end>
    ...
    80003b6c:	e8878793          	addi	a5,a5,-376 # 800059f0 <kmem>
...
0000000080003ba0 <kalloc>:
    ...
    80003bb8:	e3c78793          	addi	a5,a5,-452 # 800059f0 <kmem>
